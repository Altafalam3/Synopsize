...
def convert_to_text():
        audio_file = str(browseInput.get(1.0, END))
        ...
        if audio_file:
            textarea.insert(END, summary)  # Insert new value
...
file_label = Label(root,text="Pick The Wave File->",font="allerta_stencil",bg='#242124',foreground='white', pady=0)
...
browseInput = Text(root, height = 1.3, width =70, bd=2.3, relief='sunken',bg='#F3F0E0')
browseInput.pack()
browseInput.place(relx=0.37,rely=0.47)

cbutto = tk.Button(root, text="Convert It To Text", command=convert_to_text,height=1,width=14,bg='#C7B4F7',bd=4, relief='raise',font = ("Arial", 12))
cbutto.pack(pady=20)
cbutto.place(relx=0.01,rely=0.532)

textarea = Text(root, height = 9, width = 105, bd=7, relief='raise',bg='#F3F0E0')
textarea.pack()
textarea.place(relx=0.07,rely=0.62)

root.geometry("1000x600")
cbutto = tk.Button(root, text="Download the summary", command="",height=1,width=20,bg='#C7B4F7',bd=4.5, relief='raise',font = ("Arial", 13))
cbutto.pack(pady=20)
