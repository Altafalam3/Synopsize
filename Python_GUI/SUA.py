...
file_label = Label(root, text="Pick The Wave File->",
                   font="allerta_stencil", bg='#242124', foreground='white', pady=0)
file_label.place(relx=0.01, rely=0.4567)

bbutto = tk.Button(root, text="Browse->", command=browse_file)
bbutto.pack(pady=0)
bbutto.place(relx=0.24,rely=0.47)

T = Entry(root, width =70, bd=2.3, relief='sunken',bg='#F3F0E0')
T.pack()
T.place(relx=0.37,rely=0.47)

cbutto = tk.Button(root, text="Summarize", command=convert_to_text,height=1,width=14,bg='#C7B4F7',bd=4, relief='raise',font = ("Arial", 12))
cbutto.pack(pady=20)
...
cbutto = tk.Button(root, text="Download the summary", command=download_text, height=1,
